...
class Mario(QWidget):
    def __init__(self):
        ...
        # self.game_timer.timeout.connect(self.update_text)
        self.game_timer.start(1000 // 60)

        self.show()

    def update_text(self, painter, fitness):
        painter.drawText(780, 430, str(self.ga.generation) + '세대')
        painter.drawText(780, 445, str(self.ga.current_chromosome_index + 1) + '번 마리오')
        painter.drawText(780, 460, str(fitness))
    ...
    def paintEvent(self, event):
        ...
        painter.setPen(QPen(Qt.black))
        self.update_text(painter, current_chromosome.fitness())
